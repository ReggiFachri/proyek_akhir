                            ...
                            <div class="card-body">
                                ...
                                <form action="/Pengaduan_online/in_profile" class="custom-validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-11">
                                            <div class="my-2">
                                                <input class="form-control" type="text" name="nama" value="<?= $petugas['Nama']; ?>">
                                            </div>
                                            <div class="my-2">
                                                <input class="form-control" type="text" name="nip" disabled required minlength="16" value="<?= $petugas['NIP']; ?>">
                                            </div>
                                            <div class="my-2">
                                                <input class="form-control" type="email" name="email" value="<?= $petugas['Email']; ?>">
                                            </div>
                                            <div class="my-2">
                                                <input class="form-control" type="text" name="idLevel" value="<?= $petugas['idLevel']; ?>">
                                            </div>
                                            <div class="my-2">
