      ...
      <div class="panel-group theme-accordion" id="accordion">
        ...
        <div class="panel">
          ...
          <div id="collapse2" class="panel-collapse collapse">
            <div class="panel-body">
              <ol>
                <li>Pemberian bimbingan teknis, pemantauan dan evaluasi pelaksanaan di bidang kekayaan negara.</li>
                <li>Pemberian bimbingan teknis, supervisi, pemantauan dan evaluasi pelaksanaan di bidang penilaian.</li>
                <li>Pemberian bimbingan teknis, penggalian potensi, pemantauan dan evaluasi pelaksanaan pengurusan piutang negara.</li>
                <li>Pemberian bahan pertimbangan atas usul penghapusan, keringanan hutang, pencegahan, paksa badan atau penyelesaian piutang negara.</li>
                <li>Pemberian bimbingan teknis pengelolaan barang jaminan dan pemeriksaan harta kekayaan atau barang jaminan yang tidak diketemukan milik penanggung hutang atau penjamin hutang</li>
                <li>Pemberian bimbingan teknis, penggalian potensi, pemantauan, evaluasi dan verifikasi lelang serta pengembangan lelang</li>
                <li>Pemberian pelayanan bantuan hukum di bidang kekayaan negara, penilaian, piutang negara dan lelang.</li>
                <li>Pemberian bimbingan teknis pemantauan, evaluasi dan pelaksanaan pelayanan informasi serta pelaksanaan verifikasi pengurusan piutang negara dan lelang</li>
                <li>Pembinaan terhadap Penilai, Usaha Jasa Lelang dan Profesi Pejabat Lelang</li>
                <li>Pelaksanaan pengawasan teknis pengelolaan kekayaan negara, penilaian, pengurusan piutang negara dan lelang.</li>
                <li>Pelaksanaan penilaian dan pengurusan piutang negara dan pelaksanaan administrasi Kantor Wilayah.</li>
              </ol>
            </div>
          </div>
        </div> <!-- /panel 2 -->
